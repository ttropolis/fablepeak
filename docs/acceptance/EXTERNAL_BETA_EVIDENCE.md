...
| Scheduled-job monitoring | Pass | Non-bootstrap publish, connection and metrics runs recorded below (2026-08-28) with authenticated GitHub OIDC health green in run 33137417802. Publish-row caveat applies: queue was empty, so cron delivery of a real post is evidenced separately by human acceptance row "Scheduled mixed-network delivery" |
