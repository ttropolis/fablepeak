...
import { calCursor, mediaUploadActive, setComposerBaseline, setMediaUploadActive } from "./state.js";
...
export function openPostModal(id, dateStr){
  ...
  openModal(`
    ...
    <textarea id="pm_text" placeholder="What do you want to say?" ${locked?"disabled":""}>${esc(p?.text||"")}</textarea>
